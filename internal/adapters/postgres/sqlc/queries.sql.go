...
VALUES ($1, $2, $3, $4) RETURNING id, order_id, product_id, quantity, price_in_rubles
`
...
type CreateOrderItemParams struct {
	...
	PriceInRubles int32 `json:"price_in_rubles"`
}
...
SELECT id, name, price_in_rubles, quantity, created_at FROM products WHERE id = $1
`
...
SELECT id, name, price_in_rubles, quantity, created_at FROM products
`
...
func (q *Queries) UpdateProductStockQuantity(ctx context.Context, arg UpdateProductStockQuantityParams) error {
	_, err := q.db.Exec(ctx, updateProductStockQuantity, arg.Quantity, arg.ID)
	return err
}
